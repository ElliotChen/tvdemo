...
import tw.com.tradevan.core.domain.Auditable;
...
public abstract class AbstractBaseDao<T extends Identifiable<Oid>, Oid extends Serializable> {
	...
	public AbstractBaseDao() {
		...
		this.oidClass = (Class<Oid>) ((ParameterizedType) getClass().getGenericSuperclass()).getActualTypeArguments()[1];
	}
